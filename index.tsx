...
async function addCell(
  ...
  // FIX: Use renamed 'monacoEditor' variable.
  const editorInstance = monacoEditor.editor.create(editorContainer, {
    value: code,
  ...
  editorInstance.onDidContentSizeChange(() => {
    ...
    const lineHeight = editorInstance
      .getOptions()
      .get(monacoEditor.editor.EditorOption.lineHeight) as number;
